...
public class Game
{
	...
	public static void initializeGame() 
	{
		...
		A03 = new Item("Gold Coin",2,"Doughnut","What has no beginning, end, or middle?","Congratulations! You passed the test and you may proceed.","There might be a delicacy behind this riddle, but it may just not be the time or place for such things.","I said the answer is Skull",false,null);
		A04 = new Item("Short Pants",3,"Key","What force and strength cannot get through, I with my unique teeth can do. What am I?","Nice work! You got the Conductor's Key for solving the puzzle.","I know there's some kind of trick to this puzzle, I'll come back later.","I said the answer is Skull",false,A08);
		A05 = new Item("Revolver",4,"History","You will always find me in the past. I can be created in the present, but the future can never taint me. What am I?","Congratulations! You got the Silver Coin for solving the puzzle.","Well to my prior knowledge, sometimes its just not worth losing on this kind of gamble. I just lost a 2 points.","I said the answer is Skull",false,A02);
		A06 = new Item("Crystal Skull",5,"Stamp","I sit in a corner while traveling around the world. What am I?","Congratulations! You passed the test you may proceed.","Eh doesn't hurt to come back in a bit.","I said the answer is Skull",false,null);
		A07 = new Item("Snakeskin Oil",6,"Breath","I'm light as a feather, yet the strongest man can't hold me for more than 5 minutes. What am I?","Congratulations! You got a Gold Coin for your troubles.","You should really have entertained the Romanian beauty, she was really nice. Oh, well, that just cost you 5 points.","I said the answer is Skull",false,A03);
		A08 = new Item("Conductor's Key",7,"History","You will always find me in the past. I can be created in the present, but the future can never taint me. What am I?","Congratulations! You got the Silver Coin for solving the puzzle.","Well to my prior knowledge, sometimes its just not worth losing on this kind of gamble. I just lost a 2 points.","I said the answer is Skull",false,A02);
		A09 = new Item("Queen Elizabeth's Diamond Broach",8,"Stamp","I sit in a corner while traveling around the world. What am I?","Congratulations! You passed the test you may proceed.","Eh doesn't hurt to come back in a bit.","I said the answer is Skull",false,null);
		A10 = new Item("Miniscule Kitchen Knife",9,"Breath","I'm light as a feather, yet the strongest man can't hold me for more than 5 minutes. What am I?","Congratulations! You got a Gold Coin for your troubles.","You should really have entertained the Romanian beauty, she was really nice. Oh, well, that just cost you 5 points.","I said the answer is Skull",false,A03);
		...
		P3 = new Puzzle("Dessert",2,"Doughnut","What has no beginning, end, or middle?","Congratulations! You passed the test and you may proceed.","There might be a delicacy behind this riddle, but it may just not be the time or place for such things.","I said the answer is Skull",false,null);
