...
public class Game
{
	...
	public static void initializeGame() 
	{
		...
		C1_U = new Rooms(0, "Upper Hallway 1", "You in the upper hallway of the first car. Plenty to get pillage through up here.  Let's see, to the left is the Master Bedroom, Bathroom, and a secondary Bedroom Suite. To the right is the Passenger Seating to watch a movie, and a guest bathroom. Where do you want to go first?",null,null,null);
		C1U_STE_1 = new Rooms(1, "Master Bedroom Suite", "Sweet!  The Master Bedroom Suite, there are two large beds to your left and your right. There appears to be some jewelry on the left bed, and a sparkly item underneath the pillow on the right bed. The room appears deserted, but there seems to be some kind of noise coming from around the room.",null,null,null);
		C1U_BA_1 = new Rooms(2, "Bathroom 1", "You have entered the bathroom. Someone is in here. Yo! Do you know how to knock first? That's rude. And I don't like rude people so...time to meet your maker!",null,null,null);
		C1U_STE_2 = new Rooms(3, "Bedroom Suite 2", "Nice little bedroom for the back of the train.  It has one bed to the right of you; there might be something in there. You also see a dresser to the left, there appears to be a piece of paper attached to it, will you answer the riddle?",null,null,null);
		...
		C1U_BA_2 = new Rooms(5, "Bathroom 2", "I hope you have to use the bathroom because there's nothing else in here to do.  Pick a better place to pillage next time won't you.",null,null,null);
		C1_L = new Rooms(6, "Lower Hallway 1", "Okay, you made it safely onto the train without a hitch.  Now its time to go to work finding the loot.  On your right is the kitchen.  Bound to be a weapon in there you could use to defend yourself in case someone recognizes you from American's Most Wanted show last month.  A safer route maybe the Dining Room Area to grab a bit to eat. Maybe you should head to the bathroom to freshen up....it may be a bumpy ride.",null,null,null);
		C1L_KT_1 = new Rooms(7, "Kitchen", "You walked into the kitchen where there appears to be spoons, forks, and other various utensils. There lies a riddle on the cutting table, will you answer it?",null,null,null);
		C1L_DIN_1 = new Rooms(8, "Dining Room", "Something really smells good in here.  You're in a wide area with plenty of tables around, this must be the dining room, there appears to be someone sitting at a table minding his own business.  He is holding something very valuable that you could really use on your quest, shall you engage, or move on?",null,null,null);
		C1L_BA_3 = new Rooms(9, "Bathroom 3", "Why in the world did you come in here?  There is an extremely angered and ornery man of about less than average height.  Get ready for a fight; he won't give up his porcelain throne so easily.",null,null,null);
		C2_U = new Rooms(10, "Upper Hallway 2", "Now you're getting somewhere.  Look around take it all in.  Where to now?",null,null,null);
		C2U_BA_4 = new Rooms(11, "Bathroom 4", "ARGHHHH!!!! OCCUPIED!!! You interrupted a rival train robber doing his business. His pants are at his ankles but a fight would still seem in his favor. You quickly scan the room for any object to give you the advantage. Toilet paper, no. Hand soap, no. A plunger is resting underneath the sink. Do you grab it and fight for your life or run back into the hallway in hopes of finding a hiding place?",null,null,null);
